'use client'
import { FacebookIcon, InstagramIcon, MoveRight, TwitterIcon, YoutubeIcon } from 'lucide-react'
            ...
            <div className='p-10 flex flex-col items-center justify-center sm:flex-row sm:justify-between sm:h-[15rem]'>
                ...
                <div className='flex flex-col justify-center items-center sm:items-start h-full relative gap-6'>
                    ...
                    <div className='flex flex-col sm:flex-col-reverse sm:items-start sm:justify-between gap-6 h-full '>
                        ...
                        <div className='flex flex-col sm:flex-row items-center gap-3 uppercase text-white md:gap-12'>
                            <Link href='/'>home</Link>
                ...
                <div className='flex flex-col items-center justify-center gap-6 mt-12 sm:items-end h-full sm:justify-between'>
                    <div className='flex justify-center items-center sm:-mt-7'>
                        <button className=' uppercase tracking-widest text-sm flex items-center gap-3 text-white '>get an invite</button>
